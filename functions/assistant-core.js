...
const BUILT_IN_KNOWLEDGE = [
  ...
  {
    id: 'championship-rewards', category: 'championships', priority: 110, contentVersion: 3,
    titleFr: 'Récompenses et coupons', titleHt: 'Rekonpans ak koupon',
    contentFr: 'Le champion reçoit 2 000 HTG. Le deuxième reçoit un coupon couvrant gratuitement une inscription. Chacun des autres participants reçoit un coupon de réduction de 25 HTG. Chaque coupon est personnel, non transférable et non cumulable, et il ne peut être utilisé qu’une seule fois. Il reste valable pour le prochain championnat Mopyon et pour le prochain championnat Domino. Si le joueur laisse passer le prochain championnat d’un jeu sans s’inscrire, le coupon devient inutilisable pour ce jeu mais reste valable pour l’autre. Après un championnat manqué dans chacun des deux jeux, le coupon expire automatiquement.',
    contentHt: 'Chanpyon an resevwa 2 000 HTG. Dezyèm nan resevwa yon koupon pou yon enskripsyon gratis. Chak lòt patisipan resevwa yon koupon rabè 25 HTG. Koupon an pèsonèl, li pa ka transfere ni mete ansanm ak yon lòt koupon, epi li ka sèvi yon sèl fwa. Li rete valab pou pwochen chanpyona Mopyon an ak pwochen chanpyona Domino a. Si jwè a kite pwochen chanpyona yon jwèt pase san li pa enskri, koupon an pap mache pou jwèt sa a ankò, men li rete disponib pou lòt jwèt la. Apre jwè a rate yon chanpyona nan chak jwèt, koupon an ekspire otomatikman.',
    keywords: ['récompense', 'coupon', '2000', 'gratuit', '25 HTG', 'prochain championnat', 'rekonpans', 'koupon', 'pwochen chanpyona']
  },
  {
    id: 'match-series-and-replay', category: 'matches', priority: 110, contentVersion: 3,
    titleFr: 'Match, manches et replay', titleHt: 'Match, manch ak replay',
    contentFr: 'Une confrontation officielle est un seul match joué au meilleur de trois manches. La première manche commence avec le premier joueur, la deuxième avec le second joueur et, si une troisième manche est nécessaire, le système choisit automatiquement et aléatoirement lequel des deux commence. Le premier joueur qui gagne deux manches remporte le match; une manche ne doit jamais être comptée ou affichée comme un match indépendant. Dans « Mes matchs », la confrontation occupe une seule ligne : « Rejoindre le match » tant qu’elle est planifiée ou jouable, puis « Revoir le replay » lorsqu’elle est terminée. Le replay du match regroupe toutes les manches et permet de sélectionner celle à regarder. Les lignes sont retirées de « Mes matchs » lorsque le championnat est terminé.',
  ...
  {
    id: 'match-attendance', category: 'matches', priority: 110, contentVersion: 3,
    titleFr: 'Présence, forfait et adversaire simulé', titleHt: 'Prezans, fòfè ak advèsè simile',
    contentFr: 'Entre deux vrais joueurs, la salle ouvre cinq minutes avant l’heure publiée et l’arrivée du premier déclenche un délai de présence de cinq minutes. Si l’autre joueur ne rejoint pas avant la fin du délai, il perd le match entier par forfait de temps. Si les deux joueurs sont absents, le match est clôturé comme absence des deux joueurs et l’adversaire prévu au tour suivant avance automatiquement par bye; le motif apparaît dans le tableau. Cette règle ne s’applique jamais à un adversaire simulé : lorsqu’un vrai joueur rejoint un match contre un bot, la partie démarre automatiquement et le bot joue par le moteur serveur.',
    contentHt: 'Lè de vrè jwè ap jwe, sal la louvri senk minit anvan lè ki pibliye a epi premye moun ki antre lanse yon delè prezans senk minit. Si lòt jwè a pa antre anvan delè a fini, li pèdi tout match la pa fòfè tan. Si toude jwè yo absan, sèvè a fèmen match la kòm absans toude jwè yo epi advèsè ki te prevwa pou pwochen tou a pase pa bye; rezon an parèt nan tablo a. Règ sa a pa aplike pou yon advèsè simile : lè yon vrè jwè antre nan yon match kont bot la, pati a kòmanse otomatikman epi motè sèvè a fè bot la jwe.',
    keywords: ['cinq minutes', '5 minutes', 'absence', 'deux joueurs absents', 'double forfait', 'bye', 'forfait de temps', 'adversaire simulé', 'bot', 'senk minit', 'absans', 'de jwè absan', 'bye', 'fòfè']
  },
  {
    id: 'match-incidents-and-recovery', category: 'general', priority: 120, contentVersion: 1,
    titleFr: 'Connexion, timers et incidents pendant un match', titleHt: 'Koneksyon, delè ak pwoblèm pandan match',
    contentFr: 'Après le début d’un match officiel, une déconnexion donne 60 secondes au joueur pour revenir. Le serveur conserve la dernière action validée et la partie reprend sur cet état, sans perdre ni doubler de coup. Chaque coup de Domino et de Mopyon dispose d’un timer officiel de 30 secondes lancé par le serveur; à expiration, le joueur actif perd la manche en cours par forfait de temps, mais la confrontation continue jusqu’à deux manches gagnées. Le serveur applique ce résultat même si le joueur a quitté la page. Dans une confrontation au meilleur de trois manches, le premier joueur commence la première manche, l’autre commence la deuxième et JWETPRO choisit automatiquement le débutant de la troisième. Une panne générale JWETPRO/Firebase confirmée suspend les timers officiels et le match reprend automatiquement depuis la dernière action enregistrée. Une actualisation ou une reconnexion ne réinitialise jamais la partie.',
    contentHt: 'Apre yon match ofisyèl kòmanse, yon dekoneksyon bay jwè a 60 segonn pou li retounen. Sèvè a kenbe dènye aksyon ki valide a epi match la reprann sou eta sa a, san pèdi oswa double okenn kou. Chak kou Domino ak Mopyon gen yon delè ofisyèl 30 segonn se sèvè a ki lanse; lè delè a fini, jwè ki te gen tou a pèdi manche a pa fòfè tan, men konfwontasyon an kontinye jouk youn nan jwè yo genyen de manche. Sèvè a aplike rezilta sa a menm si jwè a kite paj la. Nan yon konfwontasyon kote se de manche pou genyen, premye jwè a kòmanse premye manche a, lòt jwè a kòmanse dezyèm nan, epi JWETPRO chwazi kiyès ki kòmanse twazyèm nan otomatikman. Lè gen yon pann jeneral JWETPRO/Firebase ki konfime, delè ofisyèl yo kanpe epi match la reprann otomatikman depi dènye aksyon ki anrejistre a. Rafrechi paj la oswa rekonekte pa janm rekòmanse pati a.',
    keywords: ['déconnexion', 'reconnexion', '60 secondes', '60 sec', 'timer', '30 secondes', 'panne serveur', 'panne JWETPRO', 'Firebase', 'reprendre le match', 'dernière action', 'dekoneksyon', 'rekonekte', '60 segonn', '30 segonn', 'pann sèvè', 'dènye aksyon']
  },
  {
