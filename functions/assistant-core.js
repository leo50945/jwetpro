...
const BUILT_IN_KNOWLEDGE = [
  ...
  },
  {
    ...
    contentFr: 'Le champion reçoit 2 000 HTG. Le deuxième reçoit un coupon couvrant gratuitement une inscription. Chacun des autres participants reçoit un coupon de réduction de 25 HTG. Chaque coupon est personnel, non transférable et non cumulable, et il ne peut être utilisé qu’une seule fois. Il reste valable pour le prochain championnat publié (Mopyon ou Domino). Si le joueur laisse passer le prochain championnat d’un jeu sans s’inscrire, le coupon devient inutilisable pour ce jeu mais reste valable pour l’autre. Après un championnat manqué dans chacun des deux jeux, le coupon expire automatiquement.',
    contentHt: 'Chanpyon an resevwa 2 000 HTG. Dezyèm nan resevwa yon koupon pou yon enskripsyon gratis. Chak lòt patisipan resevwa yon koupon rabè 25 HTG. Koupon an pèsonèl, li pa ka transfere ni mete ansanm ak yon lòt koupon, epi li ka sèvi yon sèl fwa. Li rete valab pou pwochen chanpyona Mopyon an ak pwochen chanpyona Domino ki pibliye a. Si jwè a kite pwochen chanpyona yon jwèt pase san li pa enskri, koupon an pap mache pou jwèt sa a ankò, men li rete disponib pou lòt jwèt la. Apre jwè a rate yon chanpyona nan chak jwèt, koupon an ekspire otomatikman.',
